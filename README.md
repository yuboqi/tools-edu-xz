...
可视化体测数据对比分析工具，支持多年度、多等级数据对比。

#### 核心功能

- **数据可视化**: 基于 ECharts 的精美柱状图展示
- **动态数据管理**: 支持添加/删除项目和系列
- **拖拽排序**: 通过拖动表格行调整项目显示顺序
- **实时编辑**: 表格直接编辑，实时更新图表
- **图表缩放**: 支持数据缩放和滚动查看
- **图片导出**: 一键导出高清图表图片
...
1. **批量编辑**: 可以先在表格中编辑好所有数据，再统一刷新图表
2. **拖拽排序**: 通过拖动表格行快速调整项目顺序，图表会实时更新
3. **图表缩放**: 当项目较多时，使用底部滑块或鼠标滚轮缩放查看
4. **高清导出**: 导出的图片为 2 倍像素比，适合打印和展示
5. **命名规范**: 建议系列名称使用统一格式，便于对比
